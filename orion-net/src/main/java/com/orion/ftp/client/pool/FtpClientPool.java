...
import com.orion.ftp.client.Ftps;
...
public class FtpClientPool implements AutoCloseable {
     ...
     * 如果池中连接不足是否创建而不是报错
     */
    private boolean emptyCreateTemp;
     ...
     * 如果池中连接不足是否创建而不是报错
     *
     * @param emptyCreateTemp 是否创建
     * @return this
     */
    public FtpClientPool emptyCreateTemp(boolean emptyCreateTemp) {
        this.emptyCreateTemp = emptyCreateTemp;
        return this;
    }
     ...
     * @return this
     */
    public synchronized FtpInstance getInstance() {
    ...
    public boolean isEmptyCreateTemp() {
        return emptyCreateTemp;
    }
