...
public class DbSearcher {
    ...
    public DataBlock memorySearch(long ip) throws IOException {
        ...
        return new DataBlock((int) RegionSupport.getIntLong(dbBinStr, dataPtr), new String(dbBinStr, dataPtr + 4, dataLen - 4, "UTF-8"), dataPtr);
    }
    ...
    public DataBlock getByIndexPtr(long ptr) throws IOException {
        ...
        return new DataBlock(cityId, new String(data, 4, data.length - 4, "UTF-8"), dataPtr);
    }
    ...
    public DataBlock btreeSearch(long ip) throws IOException {
        ...
        byte[] data = new byte[dataLen];
        raf.readFully(data, 0, data.length);
        return new DataBlock((int) RegionSupport.getIntLong(data, 0), new String(data, 4, data.length - 4, "UTF-8"), dataPtr);
    }
