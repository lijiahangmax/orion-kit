...
public class OkAsyncDownload {
    ...
    public OkAsyncDownload client(OkHttpClient client) {
        this.client = client;
        return this;
    }
     ...
     * @return this
     */
    public OkAsyncDownload format(Object... o) {
     ...
     * @return this
     */
    public OkAsyncDownload format(Map<String, Object> map) {
     ...
     * @return this
     */
    public OkAsyncDownload method(String method) {
        this.method = method;
        return this;
    }
     ...
     * @return this
     */
    public OkAsyncDownload method(HttpMethod method) {
     ...
     * @return this
     */
    public OkAsyncDownload charset(String charset) {
     ...
     * @return this
     */
    public OkAsyncDownload contentType(String contentType) {
     ...
     * @return this
     */
    public OkAsyncDownload queryParams(Map<String, String> queryParams) {
     ...
     * @return this
     */
    public OkAsyncDownload queryParam(String key, String value) {
        if (this.queryParams == null) {
     ...
     * @return this
     */
    public OkAsyncDownload formParts(Map<String, String> formParts) {
     ...
     * @return this
     */
    public OkAsyncDownload formPart(String key, String value) {
        if (this.formParts == null) {
     ...
     * @return this
     */
    public OkAsyncDownload queryStringEncode() {
     ...
     * @return this
     */
    public OkAsyncDownload queryStringEncode(boolean encode) {
     ...
     * @return this
     */
    public OkAsyncDownload body(String body) {
     ...
     * @return this
     */
    public OkAsyncDownload body(String body, boolean useCharset) {
        if (body == null) {
            return this;
        }
        if (useCharset) {
     ...
     * @return this
     */
    public OkAsyncDownload body(byte[] body) {
        this.body = body;
        this.bodyOffset = 0;
     ...
     * @return this
     */
    public OkAsyncDownload body(byte[] body, int offset, int len) {
        this.body = body;
     ...
     * @return this
     */
    public OkAsyncDownload headers(Map<String, String> headers) {
     ...
     * @return this
     */
    public OkAsyncDownload header(String key, String value) {
        if (this.headers == null) {
     ...
     * @return this
     */
    public OkAsyncDownload userAgent(String value) {
        if (this.headers == null) {
            this.headers = new LinkedHashMap<>();
        }
     ...
     * @return this
     */
    public OkAsyncDownload cookie(HttpCookie cookie) {
     ...
     * @return this
     */
    public OkAsyncDownload cookies(List<HttpCookie> cookies) {
        if (this.cookies == null) {
     ...
     * @return this
     */
    public OkAsyncDownload ignoreHeader(String ignoreHeader) {
     ...
     * @return this
     */
    public OkAsyncDownload ignoreHeaders(String... ignoreHeaders) {
     ...
     * @return this
     */
    public OkAsyncDownload ignoreHeaders(List<String> ignoreHeaders) {
        if (this.ignoreHeaders == null) {
     ...
     * @return this
     */
    public OkAsyncDownload tag(Object tag) {
        this.tag = tag;
        return this;
    }
     ...
     * @return this
     */
    public OkAsyncDownload buffSize(int buffSize) {
     ...
     * @return this
     */
    public OkAsyncDownload allSizeHeader(String allSizeHeader) {
     ...
     * @return this
     */
    public OkAsyncDownload skipSizeHeader(String skipSizeHeader) {
     ...
     * @return this
     */
    public OkAsyncDownload openNowRate() {
     ...
     * @param file 文件存放路径
     */
    public OkAsyncDownload download(File file) throws IOException {
        Files1.touch(file);
     ...
     */
    public OkAsyncDownload download(File file, boolean breakpoint) throws IOException {
        Files1.touch(file);
        if (breakpoint) {
     ...
     */
    public OkAsyncDownload download(OutputStream out, long skipBytes) {
        if (skipBytes <= 0) {
            this.request = this.buildHandler(new Request.Builder()).build();
        } else {
     ...
     * @param out out
     */
    private OkAsyncDownload download(OutputStream out, boolean autoClose) {
