...
public class UserExport {
    ...
    public UserExport setId(Long id) {
        this.id = id;
        return this;
    }
    ...
    public UserExport setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UserExport setDate(Date date) {
        this.date = date;
        return this;
    }
    ...
    public UserExport setCompute(String compute) {
