...
public class OkWebSocketServer {
    ...
    public void shutdown() throws IOException {
        ...
        for (Map.Entry<WebSocket, String> entry : clients.entrySet()) {
            entry.getKey().close(OkWebSocketConst.SERVER_CLOSE_CODE, OkWebSocketConst.SERVER_CLOSE_REASON);
        }
    ...
    public OkWebSocketServer sendMessageHandler(SendMessageHandler sendMessageHandler) {
